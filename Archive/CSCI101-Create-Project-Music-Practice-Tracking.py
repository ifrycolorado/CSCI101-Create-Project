...
def activity_start():
    ...
    print(f"\n{Notes_Dict['repeat_left']} You have started a new round of activity {Notes_Dict['repeat_right']}")
    print()
    ...
    print(f"\n{Notes_Dict['repeat_left']} You have started a new run {Notes_Dict['repeat_right']}")
    run_start_measures()
...
def summary_by_parameter():
    ...
    if date_choice == 1:
        starting_date = get_desired_date('\nEnter the earliest date you want (the date cannot be in the future):')
